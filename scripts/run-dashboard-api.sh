...
#   - The dashboard must run from the Hermes core checkout, which is
#     $HERMES_HOME/hermes-agent (default ~/.hermes/hermes-agent).
...
HERMES_AGENT_DIR="${HERMES_AGENT_DIR:-${HERMES_HOME:-$HOME/.hermes}/hermes-agent}"
