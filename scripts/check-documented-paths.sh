...
required_paths=(
  ...
  "scripts/check-mission-control-health.sh"
  "docs/runbooks/linux-deployment.md"
  "systemd/README.md"
  "systemd/hermes-dashboard-api.service"
  "systemd/hermes-mission-control-telemetry.service"
  "systemd/hermes-mission-control.service"
